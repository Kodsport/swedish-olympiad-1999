...
En fabrik som tillverkar kylskåp ska leverera ett större parti med $n$ kylar till en stormarknad. Till sitt förfogande har fabriken två bilar.

\begin{itemize}
  \item bil $A$ kostar $p_a$ kr/resa och kan lasta $k_a$ kylskåp åt gången.
  \item bil $B$ kostar $p_b$ kr/resa och kan lasta $k_b$ kylskåp åt gången.
\end{itemize}
...
\section*{Indata}
Indatan består av de fem heltalen $p_a$, $k_a$, $p_b$, $k_b$ ($500 \leq p_a, p_b \leq 2000$, $10 \leq k_a, k_b \leq 50$) och $n$ ($1 \leq n \leq 1000$) på en rad, separerade med ett blanksteg.
