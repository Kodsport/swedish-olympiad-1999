...
gatan är ''numrerad'' från \texttt{A} till \texttt{Z} ska programmet ta fram den längsta delsekvens ur strängen
...
\section*{Indata}
Indata är en sträng $S$ ($1 \leq |S| \leq 26$), som består av stora bokstäver \texttt{A}-\texttt{Z}.
Varje bokstav förekommer som mest en gång i strängen.


\section*{Utdata}
Skriv ut den längsta strängen som utgör en delsekvens av indatasträngen sådan att alla bokstäver
är i bokstavsordning.
Om det finns flera likvärdiga lösningar, så räcker det att ange en av dem.
